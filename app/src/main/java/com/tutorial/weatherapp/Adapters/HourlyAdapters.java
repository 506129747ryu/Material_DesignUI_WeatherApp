...
public class HourlyAdapters extends RecyclerView.Adapter<HourlyAdapters.viewHolders> {
    ...
    @NonNull
    @Override
    public HourlyAdapters.viewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HourlyAdapters.viewHolders holder, int position) {
